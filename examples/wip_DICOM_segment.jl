...
# Data obtained from: https://github.com/gibbonCode/GIBBON/blob/master/data/DICOM/0001_human_calf/dcmData.zip
# dcmFolder = "/home/kevin/DATA/Code/matlab/GIBBON/data/DICOM/0001_human_calf/dcmData"
# dcmFolder = "/home/kevin/DATA/Projects/elephant_foot/emelia manus1 CT"
dcmFolder = "/home/kevin/DATA/Projects/elephant_foot/JRH RVC elephant MRI foot load/Elephant 8 190313/unloaded"
# dcmFolder = "/home/kevin/DATA/Projects/elephant_foot/JRH RVC elephant MRI foot load/Elephant 8 190313/loaded"
...
function contour_at_click(xy_click, voxelSize, raw_image; c = NaN)
    ...
    c = contours(x[1:end-1],y[1:end-1],raw_image,[contourLevel])  
...
dicomData = dicomdir2dicomvec(dcmFolder)
sliceKeySet = sort(collect(keys(dicomData)))
...
voxelSize = (dcm.PixelSpacing[1], dcm.PixelSpacing[2], sliceStepSize)
